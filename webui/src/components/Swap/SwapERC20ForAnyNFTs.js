            ...
            <div style={{ textAlign: "center" }}>
                <button onClick={async () => {
                    ...
                    const getTokenAddr = async (swap) => {
                        const pair = new ethers.Contract(swap.pair,
                            ["function token() public pure returns (address _token)"], provider)
                    ...
                    txn = await router.swapERC20ForAnyNFTs(
                        params.swapList,
                        params.inputAmount,
                        params.nftRecipient,
                        params.deadline,
...
export default SwapERC20ForAnyNFTs